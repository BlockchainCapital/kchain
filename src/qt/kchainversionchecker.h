#ifndef KCHAINVERSIONCHECKER_H
#define KCHAINVERSIONCHECKER_H

#include <QObject>

#define KCHAIN_RELEASES "https://github.com/kchainproject/kchain/releases"
