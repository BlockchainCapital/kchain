...
void initState(){
    ...
    globalState = std::unique_ptr<QtumState>(new QtumState(dev::u256(0), QtumState::openDB(dirQtum, hashDB, dev::WithExisting::Trust), dirQtum + "/kchainDB", dev::eth::BaseState::Empty));
