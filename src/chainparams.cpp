...
static CBlock CreateGenesisBlock(const char* pszTimestamp, const CScript& genesisOutputScript, uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    genesis.hashStateRoot = uint256(h256Touint(dev::h256("e965ffd002cd6ad0e2dc402b8044de833e06b23127ea8c3d80aec91410771495"))); // kchain
    genesis.hashUTXORoot = uint256(h256Touint(dev::sha3(dev::rlp("")))); // kchain
    return genesis;
}
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 985500; // kchain halving every 4 years
        ...
        consensus.nMinimumChainWork = uint256S("0x000000000000000000000000000000000000000000000036a70ae675b98824c5"); // kchain
        ...
        genesis = CreateGenesisBlock(1527055888, 107362, 0x1f00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        //begin
        if (genesis.GetHash() != uint256S("0x000071d5aded8c20448805a9ed30f770f2940aa4b5e31fc772656a294c3f25e4"))
        {
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000071d5aded8c20448805a9ed30f770f2940aa4b5e31fc772656a294c3f25e4"));
        ...
        vSeeds.push_back(CDNSSeedData("kchain3.dynu.net", "kchain3.dynu.net", false)); // Qtum mainnet
        ...
        checkpointData = (CCheckpointData) {
            ...
            ( 0, uint256S("000071d5aded8c20448805a9ed30f770f2940aa4b5e31fc772656a294c3f25e4"))
        };
...
public:
    CTestNetParams() {
        ...
        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0x00000000000000000000000000000000000000000000000d6e528bcf5a3a556f"); // kchain
        ...
        vSeeds.push_back(CDNSSeedData("kchain4.dynu.net", "kchain4.dynu.net", false)); // Qtum testnet
...
public:
    CRegTestParams() {
        ...
        consensus.BIP34Height = 0; // BIP34 has not activated on regtest (far in the future so block v1 are not rejected in tests) // activate for kchain
