...
#include "genesis/kchainMainNetwork.cpp"
#include "genesis/kchainTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::kchainMainNetwork: return c_genesisInfoQtumMainNetwork;
	case Network::kchainTestNetwork: return c_genesisInfoQtumTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::kchainMainNetwork: return c_genesisStateRootQtumMainNetwork;
	case Network::kchainTestNetwork: return c_genesisStateRootQtumTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
