...
////////////////////////////////////////////////////////////// // kchain
	void setQtumSchedule(EVMSchedule _kchainSchedule) const { kchainSchedule = _kchainSchedule; }

	EVMSchedule& getQtumSchedule() const { return kchainSchedule; }
...
private:
	...
	mutable EVMSchedule kchainSchedule; // kchain
