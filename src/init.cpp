...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/kchainproject/kchain>";
    const std::string URL_WEBSITE = "<https://kchain.org>";
    ...
    while (!fLoaded) {
        ...
        do {
            try {
                ...
                boost::filesystem::path kchainStateDir = GetDataDir() / "stateQtum";

                bool fStatus = boost::filesystem::exists(kchainStateDir);
                const std::string dirQtum(kchainStateDir.string());
                ...
                pstorageresult = new StorageResults(kchainStateDir.string());
