...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // kchain
        hashUTXORoot.SetNull(); // kchain
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //kchain
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //kchain
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //kchain
    {
