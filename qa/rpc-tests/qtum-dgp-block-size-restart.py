...
"""
Note, these tests do not test the functionality of the DGP template contract itself, for tests for the DGP template, see kchain-dgp.py
"""
class QtumDGPActivation(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Restart the kchaind to verify that no crashes occurs on startup
